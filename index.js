...
你所在的世界有一张古老的地图，上面标注着各种重要地标——城镇、遗迹、神秘场所、危险区域等。
已有地标：{existing_landmarks}

请你以{char_name}的视角和语气，生成{count}个这个世界中的地标。
每个地标包含名称和简短描述（描述要有世界观氛围感，50-100字）。
